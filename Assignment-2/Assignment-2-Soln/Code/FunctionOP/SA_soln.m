...
% Old Rosenbrock's function with f*=0 at (1,1)
% fstr='(1-x)^2+100*(y-x^2)^2';

% New Rosenbrock's function
...
% T = alpha*T; % Old cooling schedule
% T = T_init/(1+alpha*totaleval); % New cooling schedule of section i
T = T_init*cos(totaleval)^2*exp(-alpha*totaleval); % New cooling schedule of section ii
