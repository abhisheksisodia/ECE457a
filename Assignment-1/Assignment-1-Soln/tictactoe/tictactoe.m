...
for i=1:length(player)
    if b(1)==player(i) && b(2)==player(i) && b(3)==player(i)
        win=player(i);
    elseif b(4)==player(i) && b(5)==player(i) && b(6)==player(i)
        win=player(i);
    elseif b(7)==player(i) && b(8)==player(i) && b(9)==player(i)
        win=player(i);
    elseif b(1)==player(i) && b(4)==player(i) && b(7)==player(i)
        win=player(i);
    elseif b(2)==player(i) && b(5)==player(i) && b(8)==player(i)
        win=player(i);
    elseif b(3)==player(i) && b(6)==player(i) && b(9)==player(i)
        win=player(i);
    elseif b(1)==player(i) && b(5)==player(i) && b(9)==player(i)
        win=player(i);
    elseif b(3)==player(i) && b(5)==player(i) && b(7)==player(i)
        win=player(i);
    end
end
...
function decision(handles, depth, player)
avsq=getappdata(gcbf,'avsq');
board=getappdata(gcbf,'board');
...
pause(0.5);
oldBoard = board;
[score, board] = minimaxAlphaBeta(board, depth, player, -inf, inf);
board = reshape(board, 1, 9);
oldBoard = oldBoard - board;
num = find(oldBoard);
